...
const PRESET_TEMPLATES = [
  {
    ...
    name: 'navbar',
    title: 'Navbar',
    htmlElement: '<nav class=“flex flex-wrap items-center justify-between bg-gray-500 p-6”> <div class=“mr-6 flex flex-shrink-0 items-center text-white”> <svg class=“mr-2 h-8 w-8 fill-current” width=“54" height=“54” viewBox=“0 0 54 54" xmlns=“http://www.w3.org/2000/svg”><path d=“M13.5 22.1c1.8-7.2 6.3-10.8 13.5-10.8 10.8 0 12.15 8.1 17.55 9.45 3.6.9 6.75-.45 9.45-4.05-1.8 7.2-6.3 10.8-13.5 10.8-10.8 0-12.15-8.1-17.55-9.45-3.6-.9-6.75.45-9.45 4.05zM0 38.3c1.8-7.2 6.3-10.8 13.5-10.8 10.8 0 12.15 8.1 17.55 9.45 3.6.9 6.75-.45 9.45-4.05-1.8 7.2-6.3 10.8-13.5 10.8-10.8 0-12.15-8.1-17.55-9.45-3.6-.9-6.75.45-9.45 4.05z” /></svg> <span class=“text-xl font-semibold tracking-tight”>Logo</span> </div> <div class=“block w-full flex-grow lg:flex lg:w-auto lg:items-center”> <div class=“text-sm lg:flex-grow”> <a href=“#” class=“mr-4 mt-4 block text-white hover:text-gray-200 lg:mt-0 lg:inline-block”> Option 1 </a> <a href=“#” class=“mr-4 mt-4 block text-white hover:text-gray-200 lg:mt-0 lg:inline-block”> Option 2 </a> </div> <div> <a href=“#” class=“mt-4 inline-block rounded border border-white px-4 py-2 text-sm leading-none text-white hover:border-transparent hover:bg-white hover:text-gray-500 lg:mt-0”>Action</a> </div> </div> </nav>'
  },
  {
    id: 2,
    title: 'Header',
    name: 'header',
    htmlElement: '<header class=“bg-gray-500 py-6”> <div class=“container mx-auto flex items-center justify-between”> <div class=“text-white”> <h1 class=“mb-4 text-4xl font-bold”>texto1</h1> <p class=“mb-8 text-lg”>texto 2</p> <a href=“#” class=“rounded-lg bg-white px-6 py-3 font-medium text-gray-500 hover:bg-gray-200”>action</a> </div> </div> </header>'
  },
  {
    id: 3,
    title: 'Footer',
    name: 'footer',
    htmlElement: '<footer class=“bg-white shadow dark:bg-gray-800”><div class=“mx-auto w-full max-w-screen-xl p-4 md:flex md:items-center md:justify-between”> <span class=“text-sm text-gray-500 dark:text-gray-400 sm:text-center”>© 2023 <a href=“https://flowbite.com/” class=“hover:underline”>Flowbite™</a>. All Rights Reserved. </span> <ul class=“mt-3 flex flex-wrap items-center text-sm font-medium text-gray-500 dark:text-gray-400 sm:mt-0"> <li> <a href=“#” class=“mr-4 hover:underline md:mr-6">About</a> </li> <li> <a href=“#” class=“mr-4 hover:underline md:mr-6">Privacy Policy</a> </li> <li> <a href=“#” class=“mr-4 hover:underline md:mr-6">Licensing</a> </li> <li> <a href=“#” class=“hover:underline”>Contact</a> </li> </ul> </div> </footer>'
  },
  {
    id: 4,
    title: 'Form',
...
export const FormCreateTemplate = ({ 
  ...
  const handleOnsubmit = async(e) => {
    ...
    const PROMT_MESSAGE = `${formValue.description}, tailwind, ${formValue.selector} `
  ...
  const handleSelectorTemplate = (e) => {
    ...
    const templateChosen = PRESET_TEMPLATES.filter((template) => template.title === value)
    console.log('templateChosen', templateChosen);

    setFormValue({ 
      ...formValue,
      selector: templateChosen[0].htmlElement,
    })
  }
